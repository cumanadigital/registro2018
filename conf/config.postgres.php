...
if ($var_usuario_config == 22) {
  define("DB_SERVER","localhost");
  define("DB_NAME","zesucre2017");
...
//**********************
$ruta_api       ="apiv3.0/";
$title        = "ACTUALIZACION DE DATOS 2018";
$nameapp      = "mGesPer";
$dptoweb      = "Oficina de Informática";
...
//**********************
$instucionales[]= array("Zona Educativa del Estado Sucre",	"http://www.zesucre.com.ve/", "../img/logo_me_opt.jpg", 1);	

    ...
    $(function () {
              ...
              $.ajax({
                  ...
                  success: function (response) {
                      ...
                      if (response.trim() == 'false' ) {
                        ...
                        // nom_horas_adm 37,5
                        // nom_horas_doc 0
                        // nom_fecha_ultimo_acceso null
                        // reg_id_registropersonal null
                        // reg_id_plantelesbase  null
                        ...
                        // switch(nom_personal) {
                        //   case 'ADMINISTRATIVO':
                        //       nom_personal = "ADMINISTRATIVO";
                        //       break;
                        //   case 'DOCENTE':
                        //       nom_personal = "DOCENTE";
                        //       break;
                        //   case 'OBRERO':
                        //       nom_personal = "OBRERO";
                        //       break;
                        ...
                        // $('#resumen_laboral').html('Datos Nómina: ' + nom_cod_cargo1  + ' - ' nom_cargo1 + ' - '  + nom_nomina1 );
        ...
        $('#btn_mostrar_agregar_personal').click(function () {
          ...
          // 
         // $('#form_modal_personal').validator('');
         // $('#form_modal_personal').validator('validate')
        ...
        // BOTON ENVIAR PLANTEL

        $modal_plantel.find('#btn_enviar_plantel').click(function () {
            console.log($(this).attr('id') + " --> " +  $(this).text());    

            // var nombre_periodo = $modal_plantel.find('input[name="txt_nombre_periodo"]').val();
            // var rango_fecha = $modal_plantel.find('input[name="txt_rango_fecha"]').val();
            console.info($("#form_modal_plantel").serialize() + '&accion='+ accion);
           ...
           // 
            ...
            // estado = $modal_plantel.find('input[name="txt_estado"]').val();
            // municipio = $modal_plantel.find('input[name="txt_municipio"]').val();
            // parroquia = $modal_plantel.find('input[name="txt_parroquia"]').val();
        ...
        $modal_personal.find('#btn_enviar_personal').click(function () {
            ...
            // $('#form_modal_personal').validator().on('submit', function (e) {        
    ...
    function actionFormatter2(value,row) {
      // glyphicon-ok-circle
      // var icono1 = '<a class="Eliminar" href="javascript:" title="Eliminar Registro"><i class="glyphicon glyphicon-green glyphicon glyphicon-ok-sign "></i></a>';
      var icono1 = '<a class="eliminar_personal" href="javascript:" title="Eliminar Registro"   ><i class="glyphicon glyphicon-red glyphicon-remove-circle"></i></a>';
      return icono1;
    }

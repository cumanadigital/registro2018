  ...
  function CargarJS(controlador) {
    ...
    window.actionEvents = {
        ...
        'click .comision_servicio': function (e, value, row) {
            ...
            $('#txt_id_plantelesbase_per_comision_servicio').val(row.id_plantelesbase);
            $('#txt_cod_plantel_per_comision_servicio').val(row.cod_plantel);

            var contenedor = $('#cuadro_comision_de_servicio');
            contenedor.html('');
            var id_plantelesbase29 = row.id_plantelesbase

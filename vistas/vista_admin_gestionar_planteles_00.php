                        ...
                        <div id ="cuadro_datos_laborales">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                  <input type="date" class="form-control" id="txt_fecha_ingreso" name="txt_fecha_ingreso"  placeholder="31/12/1980" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01])/(0[1-9]|1[012])/[0-9]{4}" data-pattern-error="Formato Inválido (DD/MM/AAAA)" required>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-4">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="date" class="form-control" id="txt_tiempo_servicio" name="txt_tiempo_servicio"  placeholder="31/12/1980" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01])/(0[1-9]|1[012])/[0-9]{4}" data-pattern-error="Formato Inválido (DD/MM/AAAA)" required>
                                  </div>
                                </div>
                              </div>

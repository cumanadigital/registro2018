      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul id="sidebar-menu" class="sidebar-menu">
            ...
            <!-- <li id="iniciar_sesion_admin" class="active"><a href="admin.php"><i class="fa fa-user"></i> <span>Iniciar Sesión</span></a></li> -->
            <li id="volver" class="active"><a href="index.php"><i class="fa fa-home"></i> <span>Volver</span></a></li>
          </ul><!-- /.sidebar-menu -->
